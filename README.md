Spectrometer code repository is now merged with [fossa-cli](https://github.com/fossas/fossa-cli/). Moving forth, all dev work will occur in [fossa-cli](https://github.com/fossas/fossa-cli/).
